...
This directory contains the verified 6×7 Chaos Mode non-losing prefix certificate through twelve placed pieces.
...
This is not a full empty-board solution. The twelve-piece output frontier remains to be connected to later certified layers and ultimately to the exact endgame solver.
