...
Four larger variants are solved as draws as well — 5×5 connect 5, 4×6 connect 5, 4×6 connect 6 and 4×7 connect 4 (3.5 billion states) — but their certificates exceed the publishable file size, so Perfect is not offered there; see [docs/PERFECT_CHAOS.md](docs/PERFECT_CHAOS.md).
