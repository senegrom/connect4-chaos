...
Six larger variants are solved as draws as well — 5×5 connect 5, 4×6 connect 5, 4×6 connect 6, 4×7 connect 4 (3.5 billion states), 5×6 connect 4 (5.4 billion states) and 5×6 connect 5 (26.6 billion states, solved layer by layer) — but they are past the publishable certificate size, so Perfect is not offered there; see [docs/PERFECT_CHAOS.md](docs/PERFECT_CHAOS.md).
